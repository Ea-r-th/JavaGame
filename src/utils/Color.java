...
public class Color {
	...
	public static Color sub(Color colLeft, Color colRight, Color dest) {
		if (dest == null) {
			return new Color(colLeft.col.sub(colRight.col, null));
		} else {
			colLeft.col.sub(colRight.col, dest.col);
			return dest;
		}
	}
...
//			dest.setColor(r, g, b);
	...
	public static Color add(Color color1, Color color2, Color dest) {
		if (dest == null) {
			return new Color(color1.col.add(color2.col, null));
		} else {
			color1.col.add(color2.col,dest.col);
			return dest;
		}
	}
}
