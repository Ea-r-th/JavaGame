...
public class DataStoring {
	...
	public static void packVertexData(Vector3f position, Vector3f normal, ByteBuffer buffer) {
		packVertexData(position.x, position.y, position.z, normal, buffer);
	}

	public static void packVertexData(float x, float y, float z, Vector3f normal, ByteBuffer buffer) {
