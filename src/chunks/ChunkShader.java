...
public class ChunkShader extends ShaderProgram{
    private static final String VERTEX_FILE = "src/chunks/chunkVertex.glsl"; //Defines path to vertex shader
    private static final String FRAGMENT_FILE = "src/chunks/chunkFragment.glsl"; //Path to fragment shader
